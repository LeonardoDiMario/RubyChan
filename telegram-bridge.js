...
(function () {
  ...
  // IMPORTANT:
  // telegram-bot is the Telegram webhook. Account linking lives in bright-api.
  ...
  function init() {
    ...
    // Wait for Supabase auth restoration before linking. Account linking goes
    // to bright-api; telegram-bot remains only the Telegram webhook endpoint.
    let attempts = 0;
    const tryLink = async () => {
      attempts++;
